/**
 * Reference from hierarchical-clustering (https://github.com/math-utils/hierarchical-clustering)
 */

var HierarchicalCluster = function() {
    ...
    cluster.cluster = function(options) {
    ...
    cluster.linkageOf = function(clusterA, clusterB) {
    ...
    cluster.distanceOf = function(i, j) {
